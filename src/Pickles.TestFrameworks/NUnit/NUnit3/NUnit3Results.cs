...
namespace PicklesDoc.Pickles.TestFrameworks.NUnit.NUnit3
{
    ...
    {
        public NUnit3Results(IConfiguration configuration, NUnit3SingleResultLoader singleResultLoader, NUnit3ScenarioExampleMatcher scenarioOutlineExampleMatcher)
