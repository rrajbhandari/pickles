...
namespace PicklesDoc.Pickles.TestFrameworks.NUnit.NUnit2
{
    ...
    {
        public NUnit2Results(IConfiguration configuration, NUnit2SingleResultLoader singleResultLoader, NUnit2ScenarioExampleMatcher scenarioOutlineExampleMatcher)
